...
3. Give the bot a handle (ex: `servicenowBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://servicenow.azurewebsites.net/api/messages`
